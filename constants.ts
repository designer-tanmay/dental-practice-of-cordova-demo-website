...
export const SERVICES: ServiceItem[] = [
  {
    ...
    description:
      "Routine checkups, cleanings, and sealants to keep your smile healthy.",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1598256989800-fe5f95da9787?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
    details: [
  ...
  },
  {
    ...
    iconName: "Anchor",
    image:
      "https://plus.unsplash.com/premium_photo-1661436629100-ba3c5ea70514?q=80&w=1374&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    details: [
  ...
  },
  {
    ...
    description:
      "Same-day appointments for toothaches, accidents, and urgent care.",
    iconName: "Ambulance",
    image:
      "https://plus.unsplash.com/premium_photo-1677174625106-247055639564?q=80&w=387&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    details: [
      "Toothache Relief",
      "Broken Tooth Repair",
      "Lost Crown/Filling",
...
export const FAQS: FaqItem[] = [
  {
    ...
    answer:
      "Yes, we accept most major PPO dental insurance plans including Delta Dental, Cigna, MetLife, and Aetna. We also offer financing through CareCredit.",
  },
  {
    question: "How often should I have a dental checkup?",
    answer:
      "We recommend visiting us every six months for a routine cleaning and examination to prevent issues before they start.",
  },
  {
    question: "What should I do in a dental emergency?",
    answer:
      "Call our office immediately at (901) 757-9596. We prioritize emergency cases and often offer same-day appointments.",
  },
  {
    question: "Are dental implants painful?",
    answer:
      "Most patients report less discomfort than expected. We use local anesthesia and offer sedation options to ensure your comfort throughout the procedure.",
  },
];
