    ...
    <div className="relative h-screen min-h-[700px] flex items-center overflow-hidden">
      ...
      <div
        ...
        style={{
          ...
          backgroundImage:
            'url("https://images.unsplash.com/photo-1758876017874-1332333026b2?q=80&w=2832&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D$0',
        }}
      >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pt-20">
        <div className="max-w-2xl text-left">
          <div className="inline-flex items-center px-4 py-2 mb-8 rounded-full bg-teal-500/20 border border-teal-400/30 backdrop-blur-md">
            ...
            <span className="text-teal-50 font-medium text-sm tracking-wider uppercase">
              Serving Cordova Since 2003
            </span>
          </div>
          ...
          <p className="text-lg sm:text-2xl text-slate-100 mb-10 font-light leading-relaxed max-w-lg drop-shadow-md">
            Gentle, comprehensive care for all ages. From routine cleanings to
            advanced restorative procedures, we prioritize your comfort and
            smile.
          </p>
